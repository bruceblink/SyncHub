...
import {
  ChevronRight, Download, File, Folder, FolderPlus, History, LogIn, LogOut, MonitorCog, Search,
...
function App() {
  ...
  const [page, setPage] = useState<'files' | 'sync' | 'trash'>('files')
